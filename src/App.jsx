...
const css = `
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  @media(max-width:768px){
    ...
    .start-panel{bottom:calc(var(--bottom-nav) + 12px);min-width:unset;width:calc(100% - 32px);left:16px;transform:none}
    .run-panel{bottom:calc(var(--bottom-nav) + 12px);min-width:unset;width:calc(100% - 32px);left:16px;transform:none;gap:14px;padding:14px 16px}
