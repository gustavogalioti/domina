...
const css = `
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  @media(max-width:768px){
    ...
    .start-panel{bottom:calc(var(--bottom-nav) + 12px)!important;min-width:unset!important;width:calc(100% - 32px)!important;left:16px!important;right:16px!important;transform:none!important}
    .run-panel{bottom:calc(var(--bottom-nav) + 12px)!important;min-width:unset!important;width:calc(100% - 32px)!important;left:16px!important;right:16px!important;transform:none!important;gap:12px!important;padding:14px 12px!important}
